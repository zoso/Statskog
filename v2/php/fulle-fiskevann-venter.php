...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
    <head>
        ...
        <style>
            #top .top-bg {
                background: url(../img/top/Fulle_fiskevann.jpg) 50% 0 no-repeat;
                height: 400px;
            }
        </style>
    </head>
            ...
            <div id="content-container">
                <div id="left-container" style="float: left;">
                    <div class="content-box">
                        <div class="inner-box-front">
                            <h2>Fulle fiskevann venter</h2>
                            <div class="border-down">&nbsp;</div>
                            <span class="ingress">60 000 fulle fiskevann søker flere fiskere. Som statlig grunneier kan Statskog lokke med napp i «ditt eget» fiskevann.</span><p>&nbsp;</p>
                            ...
                            <p><b>Frafall</b><br>
                            Det er ikke lenger så mange som driver med garnfiske og fiske til matauk. </p>
                            ...
                            Statskog er ikke alene om å ha få fiskere i sine vann.<p>
                            ...
                            Ikke minst er det dårlig rekruttering i de yngste årsklassene. Både Statskog og NJFF har fiskeaktiviteter rettet mot barn og unge, som omreisende fiskestevner og utdeling av stenger. Alle under 20 år kan fiske gratis på statsgrunn som ikke er statsallmenning. </p>
                            ...
                            <p><b>Stor nok?</b><br>
                            <i>Men er ikke stor fisk viktigere enn mange fisk?</i><br>
                            – Her er svaret avhengig av hvem du spør. Mange fisk er attraktivt for noen, ikke minst småbarnsfamilier og mange isfiskere. Spesialistene søker til vann og vassdrag med større fisk, sier Espen Farstad i NJFF. Jakt- og fiskeportalen inatur.no er et godt utgangspunkt for planlegging av en fisketur. Her finner du oversikt over vann og utleiehytter like ved. Statskog har ett fiskekort som gjelder for alle vann og vassdrag på statsgrunn unntatt statsallmenning, Statskogs Norgeskort. I nord eier Statskog mye av grunnen, i sør har foretaket områder som Njardarheim i Sirdalsheiene og Setesdalsheiene, Sølvverket ved Kongsberg, Varaldskogen på Finnskogen, samt deler av Femundsmarka. <br><br>  
                ...
                <div id="right-container" style="float: right;">
                    <div class="content-box-right">
                        <div class="inner-box-front">
                            <img src="../img/grafer/Grafer3-12.jpg" width="260" />
                        </div>
                    </div>
                    <p></p>
                    <img class="image-rounded-shadow" src="../img/fulle-fiskevann.jpg" width="300" />
